...
func (r *resource) readImageBuilder(ctx context.Context, prior resourceModel) (*resourceModel, diag.Diagnostics) {
	...
	imageName := util.ARNResourceSuffixOrNil(imageBuilder.ImageArn, "appstream", "image/")
	...
	state := &resourceModel{
		...
		AppstreamAgentVersion:         flattenAppstreamAgentVersion(prior.AppstreamAgentVersion, imageBuilder.AppstreamAgentVersion),
		...
		ResolvedAppstreamAgentVersion: util.StringOrNull(imageBuilder.AppstreamAgentVersion),
