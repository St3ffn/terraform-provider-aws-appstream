...
func TestFlattenApplicationIconS3Location(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			input: nil,
			want:  types.ObjectNull(applicationIconS3LocationObjectType.AttrTypes),
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := flattenApplicationIconS3Location(ctx, tt.input, &diags)
...
func TestFlattenApplicationPlatforms(t *testing.T) {
	ctx := context.Background()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := flattenApplicationPlatforms(ctx, tt.input, &diags)
