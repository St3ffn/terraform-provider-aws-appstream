...
func (ds *entitlementDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "Reads an AppStream entitlement within a specific AppStream stack. " +
			"This data source can be used to reference existing entitlements that are managed outside of Terraform.",
