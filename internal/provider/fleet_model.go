...
type fleetComputeCapacityModel struct {
...
type fleetVPCConfigModel struct {
...
type fleetDomainJoinInfoModel struct {
...
type fleetSessionScriptS3LocationModel struct {
...
type fleetRootVolumeConfigModel struct {
