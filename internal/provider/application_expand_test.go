...
func TestExpandApplicationIconS3Location(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := expandApplicationIconS3Location(ctx, tt.input, &diags)
...
func TestExpandApplicationPlatforms(t *testing.T) {
	ctx := context.Background()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := expandApplicationPlatforms(ctx, tt.input, &diags)
