...
func TestFlattenStorageConnectors(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			input:   nil,
			want:    types.SetNull(stackStorageConnectorObjectType),
			wantNil: true,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := flattenStorageConnectors(ctx, tt.input, &diags)
...
func TestFlattenUserSettings(t *testing.T) {
	ctx := context.Background()
	...
	tests := []struct {
	...
	}{
		{
			name:    "empty_input_returns_null_set",
			input:   nil,
			want:    types.SetNull(stackUserSettingObjectType),
			wantNil: true,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := flattenUserSettings(ctx, tt.input, &diags)
...
func TestFlattenApplicationSettings(t *testing.T) {
	ctx := context.Background()
	...
	tests := []struct {
	...
	}{
		{
			...
			input:   nil,
			want:    types.ObjectNull(stackApplicationSettingsObjectType.AttrTypes),
			wantNil: true,
		},
		{
			name: "all_fields_set",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := flattenApplicationSettings(ctx, tt.input, &diags)
...
func TestFlattenAccessEndpoints(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name:  "empty_input_returns_null_set",
			input: nil,
			want:  types.SetNull(stackAccessEndpointObjectType),
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := flattenAccessEndpoints(ctx, tt.input, &diags)
...
func TestFlattenStreamingExperienceSettings(t *testing.T) {
	ctx := context.Background()
	...
	tests := []struct {
	...
	}{
		{
			name:  "nil_input_returns_null_object",
			input: nil,
			want:  types.ObjectNull(stackStreamingExperienceSettingsObjectType.AttrTypes),
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := flattenStreamingExperienceSettings(ctx, tt.input, &diags)
...
func TestFlattenStackErrors(t *testing.T) {
	ctx := context.Background()
	...
	tests := []struct {
	...
	}{
		{
			name: "empty_slice",
			in:   nil,
			want: types.SetNull(stackErrorObjectType),
		},
		{
			name: "single_error",
			in: []awstypes.StackError{
			...
			want: types.SetValueMust(
				stackErrorObjectType,
				[]attr.Value{
					types.ObjectValueMust(
						stackErrorObjectType.AttrTypes,
						map[string]attr.Value{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := flattenStackErrors(ctx, tt.in, &diags)
